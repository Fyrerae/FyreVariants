...
public class FyreBarrelBlockEntity extends RandomizableContainerBlockEntity {
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected boolean isOwnContainer(Player player) {
            if (player.containerMenu instanceof ChestMenu) {
                ...
                return container == FyreBarrelBlockEntity.this;
            } else {
                return false;
            }
        }
    ...
    public FyreBarrelBlockEntity(BlockPos pos, BlockState state) {
        super(FyreBlockEntities.BARREL.get(), pos, state);
    }
    ...
    void setOpenProperty(BlockState state, boolean open) {
